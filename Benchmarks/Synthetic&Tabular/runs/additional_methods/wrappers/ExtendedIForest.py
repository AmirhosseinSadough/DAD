...
from additional_methods.wrappers import ExtIF 
...
class ExtendedIForest(BaseDetector):
    ...
    def fit(self, X, y=None):
        ...
        self.detector_ = ExtIF.iForest(X, ntrees=self.n_estimators, sample_size=max_samples, ExtensionLevel=self.extension_level)
